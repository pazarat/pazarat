...
- `23_TARGET_REPOSITORY_TOPOLOGY_CONTRACT_GATE.md`
  - mandatory topology-contract gate for structural repository generation, project-folder boundary selection, and docs/code/tunnel ownership before producing ZIPs or codebase layouts.


- `24_TASK_EXECUTION_PLAN_AND_DELIVERY_CONFORMANCE_GATE.md`
  - mandatory task-planning and delivery-conformance gate that requires meaningful project work to be planned, executed against the plan, validated, and reported before final delivery.

- `25_PROTOCOL_ENFORCEMENT_AND_NON_SLOGAN_RUNTIME_GATE.md`
  - converts repository standards from reading guidance into operational protocols with triggers, mandatory actions, evidence, validation, and failure behavior.
