...
Pazarat has been transformed into a full software project repository with the following structure:
...
For detailed codebase structure, see:
...
Current top-level content branches:
    ...
    docs/prd/dashboards/     # Formerly A_dashboards/
    docs/prd/web/            # Formerly B_web_frontend/
    docs/prd/mobile/         # Formerly C_mobile_app/

These branches are Pazarat project content and have been migrated to docs/prd/ for consolidation.
...
# Current Project Tree
    ...
    pazarat/
      ...
      docs/
        prd/
          dashboards/          # Formerly A_dashboards/
            A_PRD_dashboards.md
            A-A_admin_dashboard/
              modules/
...
The current admin dashboard content is organized under:
    ...
    docs/prd/dashboards/A-A_admin_dashboard/modules/

**Note:** Formerly at A_dashboards/A-A_admin_dashboard/modules/
...
Canonical parent artifact:
    ...
    docs/prd/dashboards/A-A_admin_dashboard/modules/business/User_Management/User_Management_PRD.md

**Note:** Formerly at A_dashboards/A-A_admin_dashboard/modules/business/User_Management/User_Management_PRD.md
...
Current parent artifact:
    ...
    docs/prd/mobile/C_PRD_mobile_app.md

**Note:** Formerly at C_mobile_app/C_PRD_mobile_app.md
...
The children are the child folders under:
    ...
    docs/prd/dashboards/A-A_admin_dashboard/modules/business/User_Management/

**Note:** Formerly at A_dashboards/A-A_admin_dashboard/modules/business/User_Management/
