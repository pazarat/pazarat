...
pazarat/
  ...
  docs/
    prd/
      ...
      web/                 # Formerly B_web_frontend/
      mobile/              # Formerly C_mobile_app/
    api/
    architecture/
    database/
...
This migration was completed to consolidate all PRDs under docs/prd/ and establish a clear documentation hierarchy.
